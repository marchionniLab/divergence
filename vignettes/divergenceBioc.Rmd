...
bibliography: divergenceBioc.bib
---
...
* \textit{msigdb\_Hallmarks}: This is a list of 17 gene sets, a subset of the hallmark functional get set collection from the MSigDB database[@liberzon2011molecular]. We will use these 17 gene sets to demonstrate the multivariate divergence workflow.
...
![Univariate workflow](../Flowchart/uni.jpg)
...
![Multivariate workflow](../Flowchart/multi.jpg)
